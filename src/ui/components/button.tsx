import ButtonInterface from '@/application/interfaces/button-interface';
...
const Button: React.FC<ButtonInterface> = ({
  ...
  return (
    <button
      className={`flex rounded px-6 py-2.5 text-sm font-medium capitalize tracking-wide transition-colors duration-300 focus:outline-none ${buttonColor} ${className}`}
      {...rest}
    >
      {children}
    </button>
